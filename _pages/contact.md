...
<div class="w3-sidebar w3-bar-block" style="width:35%; float:right; padding:10px; font-size:90%;">
...
<div style="margin-right:36%; margin-left:1%; font-size:90%;">
  <img src="../static/img/color_doppler_cropped.jpg"><br>
